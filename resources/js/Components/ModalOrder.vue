...
const form =useForm({
    ...
    nombre:props.order.nombre,
    precio:props.order.precio,
...
const update = () =>{
    ...
    form.put(route('orders.update', id),{
            ...
            <div class="modal-body">
                ...
                <form @submit.prevent="(op === '1' ? save() : update())">
                    ...
                    <div class="input-group mb-3">
                        ...
                        name="autor" v-model="form.nombre" maxlength="100" placeholder="Nombre"
                        required></TextInput>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <TextInput :id="'precio'+op" class="form-control" type="text"
                        name="precio" v-model="form.precio" maxlength="80" placeholder="precio"
                        required></TextInput>
                    </div>
                    <div v-if="form.errors.precio" class="text-sm text-danger">
                        {{ form.errors.precio }}
                    </div>
